<%-- 
    Document   : newjsp
    Created on : Apr 13, 2014, 1:41:10 AM
    Author     : dev jat
--%>
...
<div id="content">
    ...
    <div id="welcome" class="boxed" onload="setTimeout('nextPic()',2000)">
      ...
      <table>
          <tr><td><img src="Images/news/delhinewjersey.jpg" width="200" height="150"</td>
              <td><marquee behaviour="scroll" direction="left" scrollamount="4">Delhi Daredevils unveil new jersey for IPL 7</marquee>
          </td></tr>
          
          <tr><td><img src="Images/news/Kevin-Pietersen-001.jpg" width="200" height="150"</td>
              <td><marquee behaviour="scroll" direction="left" scrollamount="4">Delhi Daredevils in IPL 2014: Balanced squad that can taste glory of success</marquee>
          </td></tr>
          
          <tr><td><img src="Images/news/rohit_sharma640_ipl.jpg" width="200" height="150"</td>
              <td><marquee behaviour="scroll" direction="left" scrollamount="4">Rohit Sharma credits IPL captaincy for turning a new leaf</marquee>
          </td></tr>
          
          <tr><td><img src="Images/news/M_Id_213372_sehwag.jpg" width="200" height="150"</td>
              <td><marquee behaviour="scroll" direction="left" scrollamount="4">Virender Sehwag promises attacking cricket in IPL 7</marquee>
          </td></tr>
          
          <tr><td><img src="Images/news/Gautam-Gambhir-ipl-23392114-600-621.jpg" width="200" height="150"</td>
              <td><marquee behaviour="scroll" direction="left" scrollamount="4">IPL not as important as domestic cricket, says Gautam Gambhir</marquee>
          </td></tr>
          
          <tr><td><img src="Images/news/pollard_300_hyderabad.jpg" width="200" height="150"</td>
              <td><marquee behaviour="scroll" direction="left" scrollamount="4">Kieron Pollard sounds warning bells with breezy ton in Caribbean tourney</marquee>
          </td></tr>
