...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            {\n");
      out.write("                var $ftm = 3000;\n");
      out.write("                var $fotm = 1000;\n");
      out.write("                function slides()\n");
      out.write("                {\n");
      out.write("                    return $('#welcome').find('img');\n");
      out.write("                }\n");
      out.write("                slides().first().fadeIn($ftm);\n");
      out.write("                slides().first().addClass('active');\n");
      out.write("                $interval = setInterval(\n");
      out.write("                function()\n");
      out.write("                {\n");
      out.write("                    var $i = $('#welcome').find('img.active').index();\n");
      out.write("                    slides().eq($i).fadeOut(0);\n");
      out.write("                    slides().eq($i).removeClass('active');\n");
      out.write("                    if(slides().length == $i + 1)\n");
      out.write("                        {\n");
      out.write("                            $i= -1;\n");
      out.write("                        }\n");
      out.write("                    slides().eq($i + 1).fadeIn($ftm);\n");
      out.write("                    slides().eq($i + 1).addClass('active');\n");
      out.write("                },$fotm+$ftm\n");
      out.write("            );\n");
      out.write("            }\n");
      out.write("        </script>\n");
      ...
      out.write(" </ul>\n");
      out.write("</div>\n");
      out.write("    <div id=\"welcome\" align=\"center\">\n");
      out.write("    <img src=\"Images/indeximages/24424.jpg\" width=\"800\" height=\"500\" style=\"display: none;\">\n");
      out.write("    <img src=\"Images/indeximages/Dharamshala-Cricket-Stadium.jpg\" width=\"800\" height=\"500\"  style=\"display: none;\">\n");
      out.write("    <img src=\"Images/indeximages/Eden_gardens_ipl_2011.jpg\" width=\"800\" height=\"500\" style=\"display: none;\">\n");
      out.write("    <img src=\"Images/indeximages/IPL 4 (21).jpg\" width=\"800\" height=\"500\" style=\"display: none;\">\n");
      out.write("    </div>\n");
